...
class LoRADPORecipeDistributed(FTRecipeInterface):
            ...
            checkpoint_dict.update(
                {
                    ...
                    training.TOTAL_STEPS_KEY: self.total_epochs * self._steps_per_epoch,
                    training.EPOCHS_KEY: self.epochs_run,
                    training.TOTAL_EPOCHS_KEY: self.total_epochs,
                    training.MAX_STEPS_KEY: self.max_steps_per_epoch,
                }
    ...
    def train(self) -> None:
        ...
        for curr_epoch in range(self.epochs_run, self.total_epochs):
            ...
            pbar = tqdm(total=self._steps_per_epoch, disable=not (rank == 0), initial=self.local_step)
...
def recipe_main(cfg: DictConfig) -> None:
    ...
    config.log_config(recipe_name="CustomLoRADPORecipeDistributed", cfg=cfg)
